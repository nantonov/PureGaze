...
public sealed record GetAssignedToMeRequestsResult(int Total, IReadOnlyList<GetAssignedToMeRequestDto> AssessmentRequests);

public sealed class GetAssignedToMeRequestDto
{
    [JsonPropertyName("id")]
    ...
    public static GetAssignedToMeRequestDto ToDto(AssessmentRequest request)
        => new()
        {
            Id = request.Id,
