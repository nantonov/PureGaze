...
import type { GetAssessmentRequest } from "@/types/AssessmentRequest/AssessmentRequest.ts";
import type { GetAssessmentRequestsQuery } from "@/types/AssessmentRequest/GetAssessmentRequestsQuery.ts";

const columns: GridColDef<GetAssessmentRequestsQuery>[] = [
...
export default function MyAssessmentRequest(){
    const [rows, setRows] = useState<GetAssessmentRequestsQuery[]>([]);
